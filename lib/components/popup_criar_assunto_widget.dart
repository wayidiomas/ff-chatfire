...
import 'popup_criar_assunto_model.dart';
export 'popup_criar_assunto_model.dart';

class PopupCriarAssuntoWidget extends StatefulWidget {
  const PopupCriarAssuntoWidget({super.key});

  @override
  State<PopupCriarAssuntoWidget> createState() =>
      _PopupCriarAssuntoWidgetState();
}

class _PopupCriarAssuntoWidgetState extends State<PopupCriarAssuntoWidget> {
  late PopupCriarAssuntoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PopupCriarAssuntoModel());
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            await EncerramentoAssuntoTable().insert({
                              'assunto':
                                  _model.textFieldTituloTextController.text,
