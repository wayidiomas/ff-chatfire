...
class ConversasTestTable extends SupabaseTable<ConversasTestRow> {
  @override
  String get tableName => 'conversas_test';

  @override
  ConversasTestRow createRow(Map<String, dynamic> data) =>
      ConversasTestRow(data);
}

class ConversasTestRow extends SupabaseDataRow {
  ConversasTestRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ConversasTestTable();
