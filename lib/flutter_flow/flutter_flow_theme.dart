...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF1A2437);
  late Color secondary = const Color(0xFFFD2940);
  late Color tertiary = const Color(0xFF3F7DE8);
  late Color alternate = const Color(0xFF40C9D9);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF284273);
  late Color primaryBackground = const Color(0xFFF7F7F7);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x4C4B39EF);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xFFF5F8F9);
  late Color success = const Color(0xFF64DD17);
